(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var singleAxisPointer = function (axis) { return function (from, directionLock, scrollUntilDragDirection) {
        return action(function (_a) {
            ...
            var start = function (props, toUpdate) {
                stop();
                active = index$1(props).start(toUpdate);
            };
    ...
    var dragAction = __assign$3({}, intelligentTransition, { x: createPointer(pointerX, 'left', 'right', BoundingBoxDimension.width), y: createPointer(pointerY, 'top', 'bottom', BoundingBoxDimension.height) });
    var justAxis = function (_a) {
        var from = _a.from;
        return just(from);
    };
    var intelligentDragEnd = __assign$3({}, intelligentTransition, { x: justAxis, y: justAxis });
    ...
    var createPassiveValue = function (init, parent, transform$$1) {
        ...
        parent.raw.subscribe(function (v) { return raw.update(transform$$1(v)); });
        return { raw: raw };
    };
    ...
    var getAction = function (v, _a, _b) {
        ...
        var _c = _a.type, type = _c === void 0 ? 'tween' : _c, ease = _a.ease, def = __rest$1(_a, ["type", "ease"]);
    ...
    var pose = function (_a) {
        ...
        return poseFactory({
            ...
            convertTransitionDefinition: function (val, def, props) {
                if (isAction(def))
                    return def;
                var delay$$1 = def.delay, min = def.min, max = def.max, round = def.round, remainingDef = __rest$1(def, ["delay", "min", "max", "round"]);
    ...
    var createDimensions = (function (element) {
        ...
        return {
            ...
            measurementAsPixels: function (measurement, value$$1, type) {
                return type === percent
                    ? (typeof value$$1 === 'string' ? parseFloat(value$$1) : value$$1) /
                        100 *
                        current[measurement]
                    : value$$1;
            },
    ...
    var makeUIEventApplicator = function (_a) {
        ...
        return function (element, activeActions, poser, config) {
            ...
            var eventStartListener = listen(element, startEvents).start(function (startEvent) {
                var shouldPreventDefault = typeof preventDefault === 'function'
    ...
    var events = {
        draggable: makeUIEventApplicator({
            ...
            preventDefault: function (_a) {
                var scrollUntilDragDirection = _a.scrollUntilDragDirection;
                return !scrollUntilDragDirection;
            }
        }),
    ...
    var explicitlyFlipPose = function (state, nextPose) {
        ...
        dimensions.measure();
        var width = nextPose.width, height = nextPose.height, top = nextPose.top, left = nextPose.left, bottom = nextPose.bottom, right = nextPose.right, position = nextPose.position, remainingPose = __rest$1(nextPose, ["width", "height", "top", "left", "bottom", "right", "position"]);
            ...
            if (fromValueType !== toValueType) {
                ...
                if (!applyAtEndHasBeenCopied) {
                    ...
                    nextPose.applyAtEnd = nextPose.applyAtEnd
                        ? __assign$3({}, nextPose.applyAtEnd) : {};
                }
    ...
    var createPoseConfig = function (element, _a) {
        var onDragStart = _a.onDragStart, onDragEnd = _a.onDragEnd, onPressStart = _a.onPressStart, onPressEnd = _a.onPressEnd, draggable = _a.draggable, directionLock = _a.directionLock, scrollUntilDragDirection = _a.scrollUntilDragDirection, hoverable = _a.hoverable, focusable = _a.focusable, pressable = _a.pressable, dragBounds = _a.dragBounds, config = __rest$1(_a, ["onDragStart", "onDragEnd", "onPressStart", "onPressEnd", "draggable", "directionLock", "scrollUntilDragDirection", "hoverable", "focusable", "pressable", "dragBounds"]);
        var poseConfig = __assign$3({ flip: {} }, config, { props: __assign$3({}, config.props, { onDragStart: onDragStart,
                ...
                scrollUntilDragDirection: scrollUntilDragDirection,
                hoverable: hoverable,
                focusable: focusable,
                pressable: pressable,
    ...
    var domPose = pose({
        ...
        transformPose: function (_a, name, state) {
            var flip = _a.flip, pose$$1 = __rest$1(_a, ["flip"]);
